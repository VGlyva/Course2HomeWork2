...
public class Hogwarts {
    ...
    public void studEqualsPersonal(Hogwarts hg) {
        if (this.getSumOfFacultyProp() > hg.getSumOfFacultyProp())
            System.out.println(this.getName() + " лучший студент "+ this.faculty + " ,чем " + hg.getName());
        else System.out.println(hg.getName() + " лучший студент "+ hg.faculty + " ,чем " + this.getName());
    }
